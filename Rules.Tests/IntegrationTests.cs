...
namespace SecurePipelineScan.Rules.Tests
{
    ...
    public class IntegrationTests : IClassFixture<TestConfig>
    {
        ...
        public void Test714()
        {
            ...
            var release = client.Execute(new VstsRestRequest<SecurePipelineScan.VstsService.Response.Release>("https://raboweb.vsrm.visualstudio.com/f64ffdfa-0c4e-40d9-980d-bb8479366fc5/_apis/Release/releases/741", Method.GET));
