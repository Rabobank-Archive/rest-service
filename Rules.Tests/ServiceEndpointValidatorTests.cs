...
namespace SecurePipelineScan.Rules.Tests
{
    public class ServiceEndpointValidatorTests
    {
        ...
        public void TrueForEndpoint()
        {
            ...
            fixture.Customize<ServiceEndpoint>(e => e.With(x => x.Url, "some-endpoint.rabobank.nl").With(x => x.Id, id));
        ...
        public void FalseForEndpointContainingTestInUrl()
        {
            ...
            var id = fixture.Create<Guid>();
            fixture.Customize<ServiceEndpoint>(e => e.With(x => x.Url, "test.rabobank.nl").With(x => x.Id, id));
