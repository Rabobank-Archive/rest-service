...
namespace SecurePipelineScan.Rules.Tests
{
    public class ServiceEndpointValidatorTests : IDisposable
    {
        ...
        public void IncludesEndpointValidation()
        {
            ...
            var endpoint = new { id, url = "some-endpoint.rabobank.nl" };
        ...
        public void IsProductionEnvironment_UsingProductionEndpoint_ShouldReturnTrue()
        {
            ...
            var endpoint = new { id = endpointId, url = "some-endpoint.rabobank.nl" };
            var endpoints = JObject.FromObject(new { value = new[] { endpoint } });
        ...
        public void IsProductionEnvironment_NotUsingEndpoints_ShouldReturnFalse()
        {
            ...
            var endpoint = new { id = fixture.Create<Guid>(), url = "some-endpoint.rabobank.nl" };
            var endpoints = JObject.FromObject(new { value = new[] { endpoint } });
