...
namespace SecurePipelineScan.Rules.Release.Tests
{
    public class IsStageApprovedTests : IClassFixture<TestConfig>
    {
        ...
        public void IntegrationTest714()
        {
            ...
            var release = client.Get(new VstsRestRequest<Response.Release>("https://raboweb.vsrm.visualstudio.com/f64ffdfa-0c4e-40d9-980d-bb8479366fc5/_apis/Release/releases/741"));
