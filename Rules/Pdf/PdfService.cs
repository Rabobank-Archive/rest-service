...
namespace SecurePipelineScan.Rules.Pdf
{
    public class PdfService
    {
        ...
        public string CreateReport(string projectName, SecurityReport report)
        {
            ...
            Image logo = Image.GetInstance(Path.Combine("Pdf", "rabobank.png"));
            ...
            {
                Reference = "https://confluence.dev.rabobank.nl/display/MTTAS/Secure+Pipelines"
            };
            ...
            {
                Reference = "https://confluence.dev.rabobank.nl/display/vsts/Azure+DevOps+Project+group+permissions"
            };
            document.Add(anchor);
            document.Add(new Paragraph("\n\n\n"));
