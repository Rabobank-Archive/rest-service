...
{
    public class MultiStagePipelineHasBranchFilterTests : IClassFixture<TestConfig>
    {
        private readonly TestConfig _config;
        public MultiStagePipelineHasBranchFilterTests(TestConfig config) => _config = config;
        ...
        public async Task EvaluateIntegrationTest()
        {
            ...
            var rule = new MultiStagePipelineHasBranchFilter(client, productionItemsResolver);
